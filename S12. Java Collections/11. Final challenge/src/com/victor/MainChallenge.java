...
/**
 * Created by Victor on 2018-11-21
 */
...
*
* Items can continue to be added to the basket, but it should not be possible to reserve  more than the
* available stock of any item. An item's available stock is the stock count less the reserved amount.
*
...
*
* Add code to Main that will unreserve items after they have been added to the basket, as well as
* unreserving items that have not been added to make sure that the code can cope with invalid requested like that.
*
