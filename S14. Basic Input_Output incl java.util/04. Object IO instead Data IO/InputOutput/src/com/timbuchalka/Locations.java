...
//            }
//
        //instead of read and write each object field individually, we can read and write objects as single value
...
//                    System.out.println("Found " + numExits + " exit(s).");
...
//                locations.put(loc, new Location(loc, description.toString(), tempExit));
//            }
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
